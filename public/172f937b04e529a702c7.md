...
[Pythonista3 のカレンダー | Advent Calendar 2022 - Qiita](https://qiita.com/advent-calendar/2022/pythonista3) として、ひとりで 25 日分の記事を書いているので、iPhone でのコーディング時間世界 2 位の方と差が広がる一方です（2 位とは？）。
