...
ignorePublish: false
---
この記事は、[Pythonista3 Advent Calendar 2022](https://qiita.com/advent-calendar/2022/pythonista3) の21日目の記事です。
...
マスクの色をShader で出してみたり、目玉表現として`SCNSphere` を仕込んでみたり。色々な表現の可能性がありそうです。
