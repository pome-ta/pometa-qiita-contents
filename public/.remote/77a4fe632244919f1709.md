...
ignorePublish: false
---
この記事は、[Pythonista3 Advent Calendar 2022](https://qiita.com/advent-calendar/2022/pythonista3) の26日目後夜祭です。
...
- タイトル:
  - [Qiita API v2 でPythonista(3) の記事を取得する（Pythonista3 Advent Calendar 2022 前夜祭0日目） - Qiita](https://qiita.com/pome-ta/items/74afb37769173dab8c6c)
...
- 概要: 普段Pythonista3 を使うにあたり、自分自身が行っていることや感じていることをPythonista3 の機能とともに紹介
- 使用モジュール:
  - 特になし
- おすすめ度: ★★★☆☆
...
- タイトル:
  - [Pythonista3 のeditor module を使い、Pythonista3 のコーディングを楽にする - Qiita](https://qiita.com/pome-ta/items/c3902a0f6a0de691df8d)
  - [Pythonista3 のKeyboard で、Pythonista3 のコーディングを楽にする。人生を豊かにする。 - Qiita](https://qiita.com/pome-ta/items/5483d021fdfa44ea43e0)
...
基本的にスクリプトの完了通知を、触覚フィードバックしているが、[PythonやJupyterでiPhone/iPad先端機能を簡単･自由にプログラミング！「土台篇」：hirax](https://techbookfest.org/product/wTZTyeibm5GQ5XgdfMrEBV?productVariantID=kRDmN1udbEYZUWbETdwL8r) の書籍内で使えることに気がつき、普段使いのスクリプト全てにぶっ込んだ。
...
- タイトル:
  - [Pythonista3 のuiモジュールを使ってアプリでアプリをつくる下準備（View編）。 - Qiita](https://qiita.com/pome-ta/items/2f02d94eea73974aae88)
- 概要: GUI アプリを作成するためのui モジュールの基本的な使い方
- 使用モジュール:
  - ui
...
- タイトル:
  - [Pythonista3 のui モジュールを使って絵を描く 〜 クリエイティブコーディングする 〜 - Qiita](https://qiita.com/pome-ta/items/8e565dc6bdc283b4b80e)
...
- タイトル:
  - [ワイ「Pythonista3 のscene モジュールを紹介するんだよ？」 - Qiita](https://qiita.com/pome-ta/items/d436796a7669e7c29ea5)
- 概要: 過去scene モジュールを使って作成したコードの紹介。紹介コードをゲームに限定
- 使用モジュール:
  - scene
...
- タイトル:
  - [Pythonista3 のscene モジュールでShader コーディング。GLSL をやる。 - Qiita](https://qiita.com/pome-ta/items/57edede9a7e3ce73cdc7)
  - [ui モジュールとscene モジュールの組み合わせ - Qiita](https://qiita.com/pome-ta/items/0e2d3bd3e22fe922f2c0)
...
- タイトル:
  - [Pythonista3 でPythonista3 内のディレクトリを探訪しよう！ - Qiita](https://qiita.com/pome-ta/items/d7ce9fe64e1ba774fae4)
  - [先生ぇー！Pythonista3 のディレクトリ探索にwebbrowser モジュールは使えますかー？ 〜 使えます 〜 - Qiita](https://qiita.com/pome-ta/items/3315732c8db62a55b86b)
  - [ディレクトリ探訪の局地へ！OS の中身を覗きに行こう！（世の中にあるPythonista3 のコードをカスタムしてより良いツールへ） - Qiita](https://qiita.com/pome-ta/items/e6f32e0a24d93618f5a9)
- 概要: Pythonista3 で、iPhone 自体やPythonista3 のファイル内をPC のように閲覧できるようにする
- 使用モジュール:
  - pathlib
    - [pathlib --- オブジェクト指向のファイルシステムパス — Python 3.11.0b5 ドキュメント](https://docs.python.org/ja/3/library/pathlib.html)
  - webbrowser
...
- タイトル:
  - [objc_util のprint デバッグ。Pythonista3 の黒魔術 - Qiita](https://qiita.com/pome-ta/items/fd66f3c1c7ee6a34282e)
...
- タイトル:
  - [Pythonista3 でAVAudioSourceNode を使って音を生成して鳴らそう！ 前編 - Qiita](https://qiita.com/pome-ta/items/92a41e15b8eec5b51fb3)
  - [Pythonista3 でAVAudioSourceNode を使って音を生成して鳴らそう！ 後編 - Qiita](https://qiita.com/pome-ta/items/aa045a99947e02506f23)
- 概要: コードからリアルタイムに音を出す。
- 使用モジュール:
  - objc_util
    - [objc_util — Utilities for bridging Objective-C APIs — Python 3.6.1 documentation](https://omz-software.com/pythonista/docs/ios/objc_util.html)
...
- タイトル:
  - [Pythonista3 で3DCG やろうぜ！SceneKit のプリミティブなもので遊ぶ - Qiita](https://qiita.com/pome-ta/items/551bf5fb2448ddcacae0)
  - [Pythonista3 で3DCG やろうぜ！外部のデータをSceneKit へ呼び出したりして、絵力をつける - Qiita](https://qiita.com/pome-ta/items/843ecbff44d4bdc07fd0)
  - 概要: SceneKit をPythonista3 で呼び出して実行をする
- 使用モジュール:
  - objc_util
    - [objc_util — Utilities for bridging Objective-C APIs — Python 3.6.1 documentation](https://omz-software.com/pythonista/docs/ios/objc_util.html)
- おすすめ度: ★★☆☆☆
...
[iOS で SceneKit を試す(Swift 3) その11 - Scene Editor を使ってみる - Apple Engine](https://appleengine.hatenablog.com/entry/2017/06/16/200439)
...
- タイトル:
  - [Pythonista3 でARKit 拡張現実体験をするよーーー！！！ - Qiita](https://qiita.com/pome-ta/items/29785f0edbe582210d2f)
  - [ARKit を使ってPythonista3 で拡張現実世界の平面をトラッキングしたい - Qiita](https://qiita.com/pome-ta/items/a3fdb6613ccdb3701924)
  - [出来らあっ！　え！！Pythonista3 でAR Face Trackingを！？ - Qiita](https://qiita.com/pome-ta/items/0aa69205fb3826d9951d)
- 概要: Pythonista3 でAR を実装する。平面検出と顔の検出
- 使用モジュール:
  - objc_util
    - [objc_util — Utilities for bridging Objective-C APIs — Python 3.6.1 documentation](https://omz-software.com/pythonista/docs/ios/objc_util.html)
- おすすめ度: ★★★☆☆
...
[Metalの概要 - Apple Developer](https://developer.apple.com/jp/metal/)
...
- タイトル:
  - [WKWebView からPythonista3 でJavaScript とお戯れあそばせ - Qiita](https://qiita.com/pome-ta/items/52053dd6c9e39da6a29a)
  - [Pythonista3（WKWebView） とJavaScript の愛と友情のツープラトン 〜 コード間でのデータ受け渡し 〜。GLSL で遊ぶで！ - Qiita](https://qiita.com/pome-ta/items/d0a21d40731644c696fd)
- 概要: Pythonista3 でPython ではなく、WebView 上でJavaScript をやって、WebGL からGLSL を描画できるようにする
- 使用モジュール:
  - objc_util
    - [objc_util — Utilities for bridging Objective-C APIs — Python 3.6.1 documentation](https://omz-software.com/pythonista/docs/ios/objc_util.html)
- おすすめ度: ★★★★★
...
当初は、日本語のテキストをMarkdown 形式で書くということで、iPhone もPC も[Obsidian](https://obsidian.md/) を考えていました。vault を無理矢理GitHub 連携をしていけば端末感を気にせずに書けるのかなと。しかし、画像キャプチャとそのキャプチャした画像を貼り付けるなど、結局のところPythonista3 を開く必要がでてきてしまい、そうであればPythonista3 で全部完結すればよくね？ということで、Pythonista3 で着地しました。
...
[photos — Photo Library Access on iOS — Python 3.6.1 documentation](https://omz-software.com/pythonista/docs/ios/photos.html) を使って写真を取り込み（リサイズして）データを記事のディレクトリに生成するのと同時に、生成したファイルパスをclipboard に格納して記事にリンク先を貼れるようにしています。
...
[[Q&A] Qiitaに画像がUpできません - Qiita](https://qiita.com/deo0701/questions/708deab2f7a521d58dcd)
